...
import spring.advanced.proxy.config.v1_proxy.interface_proxy.OrderControllerInterfaceProxy;
import spring.advanced.proxy.config.v1_proxy.interface_proxy.OrderRepositoryInterfaceProxy;
import spring.advanced.proxy.config.v1_proxy.interface_proxy.OrderServiceInterfaceProxy;
